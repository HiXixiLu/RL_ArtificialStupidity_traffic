...
MAX_ACCELERATION = 27.778 / FPS               # 机动车的每帧加速度
...
O_MAX = -10.0                             # 设定的被占用的伪数据 —— 通行鼓励值
 # 在tanh的归一化函数中，上下限是[-1, 1]；1.6L 排量的百公里加速一般有12s —— 换算每秒均加速 27.77777m/s，再换算为每帧加速度
...
MAX_EPISODE = 50000    # num of games —— 进行实验的次数，也即Montecarlo序列的采集数
